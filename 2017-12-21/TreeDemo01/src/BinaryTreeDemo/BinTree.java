...
//递归地使用leaves()
    ...
    public int level(Object object){
        ...
        int righLevel=(right==null?-1:right.level(object));

        if (leftLevel<0&& righLevel<0){
            return -1;
        }

        leftLevel=leftLevel>righLevel?leftLevel:righLevel;
        return 1+leftLevel;
    }
